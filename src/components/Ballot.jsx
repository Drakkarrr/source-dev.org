  ...
  return (
    <div className="lg:w-8/12 w-11/12 mx-auto my-10">
     ...
     "
      ...
      >
        SUBMIT VOTES! {isSubmitted ? <svg role="status" className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
